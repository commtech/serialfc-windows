...
#define SERIAL_SAMPLE_RATE_DEFAULT      4
...
#define SERIAL_FRAME_LENGTH_DEFAULT     4
...
typedef struct _SERIAL_DEVICE_EXTENSION {
    ...
    PWRITE_PORT_UCHARS SerialWriteUChars;
...
__inline
VOID
SerialWritePortUChars (
    IN  UCHAR * x,
    IN  UCHAR * y,
    IN  ULONG   z
    )
{
    WRITE_PORT_BUFFER_UCHAR (x,y,z);
}
...
__inline
VOID
SerialWriteRegisterUChars (
    IN  UCHAR * x,
    IN  UCHAR * y,
    IN  ULONG   z
    )
{
    WRITE_REGISTER_BUFFER_UCHAR (x,y,z);
}
...
#define RFL_OFFSET 0x3
#define TFL_OFFSET 0x4
